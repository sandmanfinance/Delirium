...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant deliriumAddress = 0xf9b4dEFdDe04fe18F5ee6456607F8A2eC9fF6A75;
    address public constant rewardAddress = 0x89BF8234E36ABcf91207C747B388E0cE3B30A4E3;
    address public constant withdrawFeeAddress = 0xFbd37BfD354611b809054CBA049AAa7CC5fD364b;
    address public constant feeAddress = 0xFDE09bCD0EcaE4936B6458F4A31Aa469dbe4091f;
    ...
    uint256 public controllerFee = 66;
    uint256 public rewardRate = 600;
    ...
    function buyBack(uint256 _earnedAmt) internal virtual returns (uint256) {
        if (buyBackRate > 0) {
            ...
            if (earnedAddress == deliriumAddress){
